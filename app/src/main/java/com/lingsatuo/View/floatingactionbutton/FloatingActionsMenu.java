package com.lingsatuo.View.floatingactionbutton;
...
public class FloatingActionsMenu extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        mButtonSpacing = (int) attr.getDimension(R.styleable.FloatingActionsMenu_fab_buttonSpacing, mButtonSpacing);
    ...
    private boolean expandsHorizontally() {
        return mExpandDirection == EXPAND_LEFT || mExpandDirection == EXPAND_RIGHT || mExpandDirection == EXPAND_LEFT_RIGHT;
    }
    ...
    private void createNormalButton(Context context) {
    ...
    public void addExpandAnimatorListener(Animator.AnimatorListener listener)
    {
        mExpandAnimation.addListener(listener);
    }

    public void addCollapseAnimatorListener(Animator.AnimatorListener listener)
    {
        mCollapseAnimation.addListener(listener);
    }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        switch (mExpandDirection) {
            ...
            case EXPAND_RIGHT:
                ...
                break;
            case EXPAND_LEFT_RIGHT:
                addButtonX = (r - l - mAddButton.getMeasuredWidth())/2;
                addButtonTop = b - t - mMaxButtonHeight + (mMaxButtonHeight - mAddButton.getMeasuredHeight()) / 2;
                mAddButton.layout(addButtonX, addButtonTop, addButtonX + mAddButton.getMeasuredWidth(), addButtonTop + mAddButton.getMeasuredHeight());

                expandLeft = true;

                int nextXLeft = addButtonX - mButtonSpacing;
                int nextXRight = addButtonX + mAddButton.getMeasuredWidth() + mButtonSpacing;
                ...
                for (int i = 0; i < mButtonsCount; i++) {
                    ...
                    int childX = expandLeft ? nextXLeft - child.getMeasuredWidth() : nextXRight;
                    int childY = addButtonTop + (mAddButton.getMeasuredHeight() - child.getMeasuredHeight()) / 2;
                    child.layout(childX, childY, childX + child.getMeasuredWidth(), childY + child.getMeasuredHeight());
                    ...
                    nextXLeft = expandLeft ?
                            childX - mButtonSpacing :
                            nextXLeft;
                    nextXRight = expandLeft ?
                            nextXRight:
                            childX + child.getMeasuredWidth() + mButtonSpacing;
